...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "tools.recruiting.enabled": "Enable Recruiting Pipeline",
  "tools.recruiting.store.path": "Recruiting Store Path",
  "tools.recruiting.identity.minConfidenceForShortlist": "Recruiting Min Shortlist Confidence",
  "tools.recruiting.run.targetCandidatesPerRole": "Recruiting Target Candidates Per Role",
  "tools.recruiting.run.defaultCadence": "Recruiting Default Cadence",
  "tools.recruiting.browserVerification.enabled": "Recruiting Browser Verification",
  "tools.recruiting.browserVerification.mode": "Recruiting Browser Verification Mode",
  "tools.recruiting.dailyQuotas.promotedTarget": "Daily Promoted Target",
  "tools.recruiting.dailyQuotas.reviewedTarget": "Daily Reviewed Target",
  "tools.recruiting.dailyQuotas.verificationBudget": "Daily Verification Budget",
  "tools.recruiting.promotion.minProofLinks": "Min Proof Links for Promotion",
  "tools.recruiting.promotion.allowUnverifiedPromotion": "Allow Unverified Promotion",
  "tools.recruiting.laneTargeting.g1Percentage": "G1 Lane Percentage",
  "tools.recruiting.laneTargeting.g2Percentage": "G2 Lane Percentage",
